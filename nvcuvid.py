...
PFNVIDSEQUENCECALLBACK = CFUNCTYPE(CUresult, c_void_p, POINTER(CUVIDEOFORMAT))
PFNVIDDECODECALLBACK = CFUNCTYPE(CUresult, c_void_p, POINTER(CUVIDPICPARAMS))
PFNVIDDISPLAYCALLBACK = CFUNCTYPE(CUresult, c_void_p, POINTER(CUVIDPARSERDISPINFO))
PFNVIDOPPOINTCALLBACK = CFUNCTYPE(CUresult, c_void_p, POINTER(CUVIDOPERATINGPOINTINFO))
